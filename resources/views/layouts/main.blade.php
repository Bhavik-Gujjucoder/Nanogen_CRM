        ...
        <div class="header">
            ...
            <div class="header-user">
                <ul class="nav user-menu">
                                                            ...
                                                            <a href="{{ route('order_management.index') }}">
                                                                <div class="menu-details">
                                                                    ...
                                                                    <div class="menu-details-content">
                                                                        ...
                                                                        <span>Add New Order Management</span>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        </li>
                    ...
                    @else
                        @canany(['Order Management', 'Complain', 'State Management', 'City Management', 'Sales Reports',
                            'Products and Catalogue', 'Pricing and Product Variation', 'Distributors', 'Dealers', 'Manage
