                ...
                container.append(`
                    <div class="field-group">
                        <div>
                            ...
                            <input type="text" name="dealer_price[]" placeholder="Price" class="form-control">
                        </div>

                        <div>
                            <label class="col-form-label">Distributor</label>
                            <input type="text" name="distributor_price[]" placeholder="Price" class="form-control">
                        </div>
                        ...
                        <div>
                            ...
                            <select class="select addfileddrop " name="variation_options[]">
                                <option value="">Select Variation</option>
                            </select>
                        </div>
        ...
        if (type === "yes") {
            ...
            container.append(`
                <div class="field-group row">
                    ...
                    <select class="select addfileddrop load_variation_value" name="variation_options[]">
                        <option>1 L</option>
