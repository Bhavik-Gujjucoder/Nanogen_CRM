    ...
    <div class="card-body view-page">
        ...
        <div class="info-row">
            <div class="mb-3">
                ...
                <span class="info-value">{{ $distributor_dealers->sales_person->first_name . ' ' . $distributor_dealers->sales_person->last_name }}</span>
            </div>
        </div>
        @endif
        ...
        <div class="dealerlist info-row">
            ...
            <span class="info-value">{{ $distributor_dealers->registered_dealer == 'yes' ? 'Yes' : 'No' }}</span>
        </div>
        @endif
            ...
            <div class="distributer-cls">
                ...
                <div class="info-row">
                    <div class="mb-3">
                        ...
                        <span class="info-value">{{ $distributor_dealers->associate_name_address }}</span>
                    </div>
                </div>
                @endif
                @if (!empty($distributor_dealers->associate_name_address))
                        ...
                        <div class="distributer-cls">
                            ...
                            <div class="info-row">
                                <div class="mb-3">
                                    <label class="col-form-label">Indicate Size and Capacity of
                                        Godown :</label>
                                    <span class="info-value">{{ $distributor_dealers->godown_size_capacity }}</span>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="info-row">
                                <div class="mb-3">
                                    ...
                                    <span class="info-value">{{ $distributor_dealers->godown_address }}</span>
                                </div>
                            </div>
                            @endif
                        </div>
        ...
        <div class="distributer-cls">
            ...
            <div class="info-row">
                <div class="mb-3">
                    ...
                    <span class="info-value">{{ $distributor_dealers->date ? \Carbon\Carbon::parse($distributor_dealers->date)->format('d M Y') : '' }}</span>
                </div>
            </div>
            @endif
        </div>
                ...
                <div class="distributer-cls">
                    ...
                    <div class="info-row">
                        <div class="mb-3">
                            ...
                            <span class="info-value">{{ $distributor_dealers->godown_capacity_area }}</span>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="info-row">
                        <div class="mb-3">
                            ...
                            <span class="info-value">{{ $distributor_dealers->godown_capacity_inbags }}</span>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="info-row">
                        <div class="mb-3">
                            ...
                            <span class="info-value">{{ $distributor_dealers->experience_capability }}</span>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="info-row">
                        <div class="mb-3">
                            ...
                            <span class="info-value">{{ $distributor_dealers->financial_capability }}</span>
                        </div>
                    </div>
                    @endif
                </div>
