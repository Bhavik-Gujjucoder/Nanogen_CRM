                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="mb-3">
                            ...
                            <strong>{{ $complain->distributorsDealers->firm_shop_name }}
                                {{ $complain->distributorsDealers->user_type == 1 ? '(Distributor)' : ($complain->distributorsDealers->user_type == 2 ? '(Dealer)' : '') }}</strong>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="mb-3">
                            ...
                            @if ($complain->complain_image)
                                ...
                                @if ($files)
                                    <div class="mt-3">
                                        ...
                                        <div class="d-flex flex-wrap gap-2 mt-2" id="existingFiles">
                                            @foreach ($files as $file)
                                                @php
                                                    $ext = strtolower(pathinfo($file, PATHINFO_EXTENSION));
                                                    $fileUrl = asset('storage/complain_images/' . $file);
