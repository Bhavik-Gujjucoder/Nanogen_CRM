...
<head>
    ...
    <title>Nanogen Agrochem</title>
</head>

<body>
    <table width="600px" cellpadding="0" cellspacing="0"
        style="font-family: Roboto, sans-serif; margin: 0 auto; color: #000000; font-size: 14px; font-weight: 400; border: none; line-height: 24px;">
        <tbody style="background: #fff;box-shadow: 0 0 15px rgba(0, 0, 0, .1);padding: 15px;display: block;">
            <tr>
